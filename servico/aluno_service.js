class AlunoService {
  ...
  inserir(nome, idade, matricula) {
    ...
    if (alunoPesquisado.length > 0) {
      window.alert("Aluno já cadastrado!");
      throw new Error("Aluno já cadastrado!");
    }
    if (idade < 18) {
      window.alert("Não é possível cadastrar um aluno menor de idade.");
      throw new Error("Não é possível cadastrar um aluno menor de idade.");
    }
